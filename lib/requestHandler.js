...
var	objectId = require("mongodb").ObjectID,
	productID="",
	body = "";
var validatesEmail = require('email-validator');
var dateISO = Math.floor(Date.now()/1000);
var common = require('../commonFunctions/common');
var dateHRF = common.getHRFDate();
var errMsg = require('../errors/errorCodes');
var product = require('./models/operations.js');
...
module.exports.defaultRoute = function (req, res) {
    ...
    req.on('end', function () {
 	    res.end('Welcome, you should probably be hitting /users, /add, /delete, /search, /edit, /login. Best of luck!');
	});
};
